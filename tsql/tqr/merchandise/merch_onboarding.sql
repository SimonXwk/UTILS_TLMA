...
select
  ...
  ,[M_TOTAL] = SUM(CASE WHEN t3.SOURCETYPE like 'Merch%' THEN t3.PAYMENTAMOUNT ELSE 0 END)
  ,[M_PURCHASE] = SUM(CASE WHEN t3.SOURCETYPE like 'Merch%Purchase' or t3.SOURCETYPE like 'Merch%Postage' THEN t3.PAYMENTAMOUNT ELSE 0 END)
  ,[M_PLEDGE] = SUM(CASE WHEN t3.SOURCETYPE like 'Merch%Sponsorship'THEN  t3.PAYMENTAMOUNT ELSE 0 END)
  ,[M_DONATION] = SUM(CASE WHEN t3.SOURCETYPE like 'Merch%Donation'THEN  t3.PAYMENTAMOUNT ELSE 0 END)
  ,[M_GOL] = SUM(CASE WHEN t3.SOURCETYPE like 'Merch%Gift%of%love'THEN  t3.PAYMENTAMOUNT ELSE 0 END)
