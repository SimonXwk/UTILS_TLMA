...
, cte_pledge_actual as (
  SELECT
    ...
    ,[DAILY_TOTAL] = SUM(Tbl_BATCHITEMSPLIT.PAYMENTAMOUNT)
  ...
  WHERE
    ...
    AND TBL_BATCHITEM.DATEOFPAYMENT >= DATEFROMPARTS(/*<START_YEAR>*/@FY-1/*</START_YEAR>*/,/*<START_MTH>*/7/*</START_MTH>*/,/*<START_DAY>*/1/*</START_DAY>*/)
    AND TBL_BATCHITEM.DATEOFPAYMENT <= DATEFROMPARTS(/*<END_YEAR>*/@FY/*</END_YEAR>*/,/*<END_MTH>*/6/*</END_MTH>*/,/*<END_DAY>*/30/*</END_DAY>*/)
  GROUP BY
    TBL_BATCHITEMPLEDGE.PLEDGEID,TBL_BATCHITEMPLEDGE.ADMITNAME, TBL_BATCHITEMPLEDGE.SERIALNUMBER
...
-- select
--   t1.*
--   ,t5.DATEOFPAYMENT,t5.ACTUAL_SCOURCE1,t5.DAILY_TOTAL,t5.REVERSED
-- from
--   cte_pledge_actual t5
--   left join cte_pledge t1 ON (t5.PLEDGEID=t1.PLEDGEID)
select * from  cte_pledge_actual